        ...
        <div
            ...
            <div
                ...
                <div className="relative flex items-center justify-between">
                    <NavLink to='/' onClick={homeHandler} className="inline-flex items-center">
                    ...
                    <ul className=" items-center hidden space-x-6 lg:flex">
                        ...
                        <li>
                            <a
                                href='https://drive.google.com/file/d/1uCJCkurHTOvBYln60EfZBYMj9-OeJMHD/view?usp=sharing'
                                aria-label="contact"
                                title="contact"
                                download={true}
