...
import './Banner.css';
import bannerPhoto from '../../../assets/palash.JPG';
    ...
    return (
        <div className="md:grid  grid-cols-1 md:grid-cols-5  mx-auto  md:my-0 gap-8 " >
            ...
            <div className='md:col-span-2' >
                <div className='bg-purple-100 card-shadow rounded-lg lg:w-[428px] lg:h-[430px] lg:p-[14px] p-4  ' data-aos="fade-right" data-aos-duration="2000">
                    
                    <img src={bannerPhoto} alt="" className=' rounded-lg lg:w-[400px] lg:h-[400px] ' />
            ...
            <div className='md:col-span-3 lg:mt-5  mt-12 lg:ml-5' data-aos="fade-left" data-aos-duration="2000">
                <h1 className='lg:text-5xl md:text-4xl text-4xl font-semibold  monoster-fonts text-center md:text-left'>
                    Hi, I'm <span className='lg:text-5xl md:text-4xl font-semibold top-font monoster-fonts text-4xl text-center md:text-left'>Palash Akand</span>
                </h1> 
                ...
                <div className=' md:flex lg:gap-28 lg:mt-14 mt-8 md:gap-3'>
                    <div>
                        ...
                        <div className='flex  mt-3 gap-5 md:gap-3 lg:gap-5 justify-center md:justify-start'>
                            <a href='https://www.facebook.com/palash.ahmed.756412/' target='_blank' className='p-4 rounded-lg card-shadow bg-gray-100 shadow-slate-400 hover:bg-[#FF014F]   cursor-pointer block text-gray-600 hover:text-white ' viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <FaFacebook className=' text-2xl  ' />
                            </a>
                            <a href='https://github.com/Palash-ahmed' target='_blank' className='p-4 rounded-lg card-shadow bg-gray-100 shadow-slate-400 hover:bg-[#FF014F]  hover:text-white cursor-pointer block '>
                                <FaGithub className='text-2xl  ' />
                            </a>
                            <a href='https://www.linkedin.com/in/md-palash-akand-4166ba24a/' target='_blank' className='p-4 rounded-lg card-shadow bg-gray-100 shadow-slate-400   cursor-pointer block hover:text-white hover:bg-[#FF014F] '>
